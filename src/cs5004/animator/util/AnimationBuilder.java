...
//do we need to implement this inside our model class?
  //or do we create a class in the controller for this?
  //in this taking the parsed file and giving it to the model?
  /**
